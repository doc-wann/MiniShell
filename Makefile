...
#	gcc -g3 main.c ./libft/*.c ./builtins/ft_echo.c ./builtins/ft_pwd.c ./builtins/ft_env.c ./builtins/ft_cd.c ./builtins/aux/*.c -lreadline -o minishell
	clear
	@gcc -g3 main.c builtins/ft_export.c ./utils/error_msg.c ./libft/*.c ./hashmap/ht*.c ./builtins/ft_exit.c ./builtins/ft_echo.c ./builtins/ft_cd.c ./builtins/ft_pwd.c ./builtins/ft_env.c ./builtins/aux/*.c -I./includes/ -lreadline -o minishell
